...
public class MenorSalarioEdadMinimaTest {

    @Test
    public void testMenorSalarioEdadMinima() {
        ...
        Empleado resultado = TodoEmpleado.menorSalarioEdadMinima(empleados);

        assertNotNull(resultado);
        assertEquals("André", resultado.getNombre());
        assertEquals(22, resultado.getEdad());
        assertEquals(20000, resultado.getSalario());
    }
}